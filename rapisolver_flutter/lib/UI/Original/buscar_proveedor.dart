                      ...
                      ListTile(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      PerfilSupplier(filtro[i].usuarioId)));
                        },
                        title: Text(
                          filtro[i].name,
                        ...
                        trailing: Image.network(
                            'https://static-2.gumroad.com/res/gumroad/1211634803146/asset_previews/0117e60f054c218e172a1c160031f0a1/retina/support-notes-colour-thumbnail.png'),
                      )
                    ],
                  ),
                ),
