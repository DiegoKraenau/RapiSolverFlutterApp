    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context,
            AsyncSnapshot<List<ServiceCategory>> snapshot) {
...
class _AgregarServicioSupplier extends StatefulWidget {
  ...
  @override
  __AgregarServicioSupplierState createState() =>
      __AgregarServicioSupplierState(supplier, categorias);
}
...
class _FormularioAgregarServicio extends StatefulWidget {
  ...
  @override
  __FormularioAgregarServicio createState() =>
              ...
              child: Row(
                ...
                children: <Widget>[
                  RaisedButton(
                    ...
                    onPressed: () async {
                      var respuesta =
                          await ServiceDetailsService.addServicieDetail(
                              supplier.supplierId,
