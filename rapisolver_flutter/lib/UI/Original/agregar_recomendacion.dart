...
class AgregarRecomendacion extends StatefulWidget {
  ...
  @override
  _AgregarRecomendacionState createState() =>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            var respuesta = await RecommendationService.addRecommendation(
...
class _FormularioAgregarRecomendacion extends StatefulWidget {
  ...
  @override
  __FormularioAgregarRecomendacionState createState() =>
      __FormularioAgregarRecomendacionState(this.supplier);
}

class __FormularioAgregarRecomendacionState
    extends State<_FormularioAgregarRecomendacion> {
  Supplier supplier;
    ...
    return Column(
      children: <Widget>[
        ...
        FadeAnimation(
            1.8,
            Center(
              child: Text(supplier.name + ' ' + supplier.lastName,
