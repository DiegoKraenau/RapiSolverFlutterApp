...
class AgregarReserva extends StatefulWidget {
  ...
  @override
  _AgregarReservaState createState() =>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          var respuesta = await ReservationService.addReservation(
              servicioId,
              global.idUser,
              supplier.supplierId,
              global.datetime.toString(),
...
class _FormularioAgregarReserva extends StatefulWidget {
  ...
  @override
  __FormularioAgregarReservaState createState() =>
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    showDatePicker(
                            context: context,
                            initialDate: global.datetime == null
                                ? DateTime.now()
                                : global.datetime,
